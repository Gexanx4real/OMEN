...
## Alpha 1.3.3 — Portable build update (April 2026)

Fresh **PyInstaller** build from current source: **bugfixes and polish** since Alpha 1.3.2. Details: development repository commit history.
